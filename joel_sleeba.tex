...
\AtBeginDocument{\hypersetup{colorlinks,urlcolor=cyan}}
\begin{document}
\makecvtitle

\section{About Me}
I am a math graduate from \underline{\href{https://iisertvm.ac.in/}{IISER Thiruvananthapuram}}. As part of my Master’s thesis, I worked on Fourier analysis under the supervision of \underline{\href{https://iisertvm.ac.in/faculty/devarajp}{Dr. P Devaraj}}. Currently, I am reading on \textbf{C* algebras and operator algebras} with \underline{\href{https://iqac.cusat.ac.in/Web/profile_view/433/Dr.SHANKARP}{Dr. P Shankar}}. I am also learning to use \href{https://leanprover-community.github.io/index.html}{\underline{Lean theorem prover}} by working through \underline{\httplink[Mathematics in Lean]{https://leanprover-community.github.io/mathematics_in_lean/index.html}}. Besides math, I am interested in computer programming, Linux, photography and movies.

\section{Education}
  \cventry{2021--2023}{M.Sc Mathematics}{IISER Thiruvananthapuram}{GPA: 8.38}{}{
    % \begin{itemize}
      \textbf{Relevant courses:} Functional Analysis, Measure Theory, Topology, Abstract Algebra, Analysis on Manifolds, Finite Frames, Represenatation Theory, Machine Learning
      % \item \textbf{Readings} 
      %   \begin{itemize}
      %     \item \emph{Functional Analysis}, S. Kesavan
  ...
  \cventry{2018--2021}{B.Sc Mathematics}{Madras Christian College}{}{GPA: 8.03}{
    % \begin{itemize}
      \textbf{Relevant courses:} Real Analysis, Algebra, Linear Algebra, Number Theory, Discrete Mathematics
      % \item \textbf{Readings}
      %   \begin{itemize}
...
\cventry{2023 June -- present}{Reading Project}{Dr. P Shankar}{Cochin University of Science and Techhnology}{}{}

% \cventry{2023 Jan -- 2023 April}{Masters Thesis}{Dr. P Devaraj}{IISER Thiruvananthapuram}{}{Learned about Fourier series, convergence of Fourier series, Fourier transforms in $L^1(\mathbb{R})$ and $L^2(\mathbb{R})$. I also understood classical Paley Wiener theorems and surveyed problem no. 4 from \emph{Some Problems in Harmonic Analysis}, 2017, Grafokos et al.}

\subsection{Master's Thesis}
\cvitem{Title}{A Study in Fourier Analysis: From Circle, Through the Line, to the Complex}
\cvitem{Supervisor}{Dr. P Devaraj}
\cvitem{Institute}{IISER Thiruvananthapuram}
\cvitem{Description}{
  Learned about Fourier series, convergence of Fourier series, Fourier transforms in $L^1(\mathbb{R})$ and $L^2(\mathbb{R})$. I also understood classical Paley Wiener theorems and surveyed problem no. 4 from \emph{Some Problems in Harmonic Analysis}.
  Readings:
  \begin{itemize}
    \item \emph{Early Fourier Analysis}, Hugh L. Montgomery
    \item \emph{Real and Complex Analysis}, Walter Rudin
    \item \emph{Some Problems in Harmonic Analysis}, 2017, Grafokos et al.
  \end{itemize}
}
