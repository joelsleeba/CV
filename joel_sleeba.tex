...
\cvitem{Title}{Holomorphic Fourier Transforms}
\cvitem{Supervisor}{Dr. P Devaraj}
\cvitem{Description}{
  During this project I learned about Fourier series, convergence of Fourier series, Fourier transforms in $L^1(\mathbb{R})$ and $L^2(\mathbb{R})$. I also understood classical Paley Wiener theorems and have surveyed problem no. 4 from \emph{Some Problems in Harmonic Analysis}.
  Readings:
  \begin{itemize}
